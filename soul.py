...
TOKEN = '8175435417:AAGBi2iHRo9xaYzU_cDmvqY9xLSlWIEMjxc'
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: @SAYYED_Z*", parse_mode='Markdown')  # Contact owner message
            return
...
def myinfo_command(message):
    ...
    if not user_data:
        ...
        response += "*Please reach out to the owner for assistance: @SAYYED_Z* 🙏"  # Contact owner message
    else:
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO DDOS WORLD!* 🎉\n\n"
                                           ...
                                           "*⚠️ Remember, with great power comes great responsibility! Use it wisely... or let the chaos beign!* 😈💥", 
                                           parse_mode='Markdown')
    except Exception as e:
